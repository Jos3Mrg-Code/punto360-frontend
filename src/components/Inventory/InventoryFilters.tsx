        ...
        <>
            <div className="bg-app-card backdrop-blur-md border border-app-border rounded-2xl p-4 md:p-6 shadow-xl space-y-5">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    {/* Búsqueda + Cámara */}
                    <div className="relative flex-[2] flex gap-2">
                        ...
                        <button
                            ...
                            className="flex items-center justify-center w-12 h-12 bg-app-bg border border-app-border rounded-xl text-app-text-muted hover:text-app-accent hover:border-app-accent/40 transition-all shrink-0"
                        >
                            <ScanLine size={20} />
                        </button>
                    </div>
